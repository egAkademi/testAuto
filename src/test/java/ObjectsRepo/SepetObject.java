...
public class SepetObject {
    ...
    public static final By silBtn = By.cssSelector("[title='Sil'][class='btn-delete btn-update-item']");
    public static final By sepetBostxt = By.cssSelector("[class='gg-d-19 gg-w-21 gg-t-19 gg-m-18'] >h2");
